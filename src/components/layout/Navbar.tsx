...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div className="sticky top-3 z-30 px-3 sm:px-6 w-full max-w-7xl mx-auto pointer-events-none transition-all duration-300">
        <header className="pointer-events-auto h-16 rounded-2xl sm:rounded-3xl border border-zinc-700/80 bg-[#12141C]/85 backdrop-blur-xl px-4 sm:px-6 flex items-center justify-between shadow-2xl shadow-black/60 ring-1 ring-white/10">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="flex items-center px-3 py-1.5 rounded-2xl bg-[#181B24] border border-zinc-700/80 text-xs shadow-sm">
            ...
            <div className="hidden 2xl:flex items-center px-2.5 py-1 rounded-xl bg-[#181B24] border border-zinc-800 text-xs">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-2.5 py-1.5 rounded-xl bg-zinc-800/90 hover:bg-zinc-700 text-zinc-200 hover:text-white text-xs border border-zinc-700 transition-colors"
            ...
            <button
              ...
              className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-semibold text-xs border border-zinc-700 transition-all"
            >
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 p-1 rounded-2xl bg-[#181B24] border border-zinc-800 hover:border-zinc-700 transition-colors"
                >
                  <img
                    src={user.avatar}
                    alt={user.name}
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-2xl bg-gradient-to-b from-zinc-600 to-zinc-700 hover:from-zinc-500 hover:to-zinc-600 text-white border border-zinc-500 text-xs font-bold transition-all shadow-md"
              >
                Sign In
              </button>
            )}
