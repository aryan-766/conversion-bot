    ...
    <div className="space-y-6 pb-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2">
          <span className="inline-flex items-center text-xs font-semibold px-3 py-1.5 rounded-xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-emerald-950/60 via-slate-900 to-teal-950/40 border border-emerald-500/40 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <div className="text-4xl font-extrabold text-white tracking-tight mt-1 flex items-baseline gap-2">
              ...
              <span className="text-sm font-medium text-emerald-300/80">Relative CVR Boost</span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-emerald-500/30 text-right md:text-right shrink-0">
            <div className="text-xs text-slate-400">Measured Incremental Revenue</div>
            <div className="text-2xl font-bold text-emerald-400 font-mono mt-0.5">
              +₹{(experiment.revenueLiftAmount / 100000).toFixed(2)} Lakhs
            </div>
            <div className="text-[10px] text-slate-500 mt-0.5">Pure experiment lift vs baseline</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <span className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Group A</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
              <div className="text-[11px] text-slate-400">Conversions</div>
              <div className="text-xl font-bold text-white font-mono mt-1">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800">
              <div className="text-[11px] text-slate-400">Average Order (AOV)</div>
              <div className="text-xl font-bold text-slate-300 font-mono mt-1">
          ...
          <div className="pt-2">
            <div className="text-xs text-slate-400">Total Revenue Generated:</div>
        ...
        <div className="p-6 rounded-2xl bg-slate-900 border border-emerald-500/40 shadow-xl shadow-emerald-950/20 space-y-5 relative overflow-hidden">
          <div className="absolute top-0 right-0 h-16 w-16 bg-emerald-500/10 rounded-bl-full pointer-events-none"></div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950/70 border border-slate-800">
              ...
              <div className="text-xl font-bold text-emerald-400 font-mono mt-1 flex items-baseline gap-1.5">
                ...
                <span className="text-xs font-bold text-emerald-300">(+{experiment.conversionLiftPercent}%)</span>
              </div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-950/70 border border-slate-800">
              <div className="text-[11px] text-slate-400">Average Order (AOV)</div>
      ...
      <div className="p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          ...
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
            <div className="font-semibold text-emerald-300">2. AI-Assisted Revenue</div>
            <p className="text-slate-400 leading-relaxed">
              Visitor received a proactive trigger (sizing help, objection resolution) that unblocked the purchase.
            </p>
          </div>
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
            <div className="font-semibold text-cyan-300">3. Experimental Incremental Lift</div>
            <p className="text-slate-400 leading-relaxed">
